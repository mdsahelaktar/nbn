...
<div class="popup"><h2 class="helvetica float-left uppercase"><?php echo $results[0]->headline?></h2>
    ...
    <div class="width220 float-left">
      ...
      <p class="colr999">
	          <?php if(!empty($broker_cimage[0]->service_area))
				{
				echo $broker_cimage[0]->service_area ?> <?php echo _e( 'biz_bro' ); ?></p>
         <?php  }?>
      ...
      <p class="colr999"><?php echo ucfirst($broker_fullname); ?> <br />
        ...
        <?php if(!empty($broker_cimage[0]->service_area))
				{
				echo $broker_cimage[0]->service_area ?> <?php echo _e( 'biss_list_bro' ); ?></p>
         <?php  }?>
...
<div msg="sent_respons"></div>	
  ...
  <?php echo form_open( '', array( 'name' => 'details_mail_form', 'id' => 'details_mail_form', 'class' => 'cont-biz-seller') )?>
  <?php echo form_hidden('user_id', $results[0]->user_id); ?>
    <p class="width50 float-left margin-bottom10"> <dfn class="float-left width20 font14"><?php echo _e( 'name' ); ?>:</dfn>
      <?php echo form_input( array( 'name' => 'name', 'id' => 'name', 'placeholder' => 'Name', 'class' => 'validate', 'data-rules' => 'required' ) );?>
    </p>
    <p class="width50 float-left margin-bottom10"> <dfn class="float-left width20 font14"><?php echo _e( 'email' ); ?>:</dfn>
      <?php echo form_input( array( 'name' => 'email', 'id' => 'email', 'placeholder' => 'Email', 'class' => 'validate', 'data-rules' => 'required' ) );?>
    </p>
    <p class="width50 float-left margin-bottom10"> <dfn class="float-left width20 font14"><?php echo _e( 'ph' ); ?>:</dfn>
      <?php echo form_input( array( 'name' => 'phone', 'id' => 'phone', 'placeholder' => 'Phone', 'class' => 'validate', 'data-rules' => 'required' ) );?>
    </p>
   
    <p class="float-left margin-bottom10 width45"> <dfn class="float-left width20 font14"><?php echo _e( 'msg' ); ?>:</dfn>
       <?php echo form_textarea( array( 'name' => 'message', 'id' => 'message', 'placeholder' => 'Message', 'rows' => 5, 'class' => 'validate', 'data-rules' => 'required') );?>
    </p>
    <p class="float-left margin-bottom10 width45" style="margin-top: -60px;">
     <label> <?php echo form_checkbox('newsletter', 1, '', 'id="newsletter"');?>
      <?php echo _e( 'like_buy' ); ?>.</label> </p>
    <p class="float-left margin-bottom10 width45" >
     <label> <?php echo form_checkbox('learnchk', 1, '', 'id="learnchk"');?>
      <?php echo _e( 'learn_to' ); ?></label> </p>
        <p class="width45 float-left margin-left35 margin-bottom10">
      <?php echo form_submit( array( 'name' => 'details_frm', 'id' => 'details_frm', 'class' => 'margin-top10 float-right' ), _e( 'Contact Seller' ) );?>
    </p>
<?php echo form_close()?>
   </div>
   </div>
