      ...
      <div class="fullwidthform-new">	  
        <ul>
          <?php
            ...
            ?>
          <li> <?php echo form_label('<dfn>' . _e('Headline') . '</dfn>', 'headline') ?> <?php echo form_input(array('name' => 'headline', 'id' => 'headline', 'size' => 30, 'value' => $results["records"][0]->headline, 'placeholder' => 'add headline here', 'class' => 'validate', 'data-display' => _e('Headline'), 'data-rules' => 'required')); ?></li>
          ...
          <li id="province_selector"> <?php echo form_label('<dfn>' . _e('State/Province') . '</dfn>', 'province_id') ?> <?php echo form_dropdown('province_id', $var['provinces_dd'], $results["records"][0]->province_id, 'id="province_id" disabled="disabled" onchange="getCountyByProvince(this)" data-county-sel="#county_id" class="validate" data-display="' . _e('Province') . '" data-rules="required"'); ?></li>
