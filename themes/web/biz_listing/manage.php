    ...
    ?>
	  ...
	  <?php echo renderResposeMessage('biz_listing', $response) ?>
        <ul>
          ...
          <li> <?php echo form_label('<dfn>' . _e('Tagline') . '</dfn>', 'tagline') ?> <?php echo form_input(array('name' => 'tagline', 'id' => 'tagline', 'size' => 30, 'value' => $results["records"][0]->tagline, 'placeholder' => 'add tagline here', 'class' => 'validate', 'data-display' => _e('Tagline'), 'data-rules' => 'required')); ?></li>
          <li><?php echo form_label('<dfn>' . _e('Description') . '</dfn>', 'description') ?> <?php echo form_textarea(array('name' => 'description', 'id' => 'description', 'value' => $results["records"][0]->description, 'placeholder' => 'add description here', 'class' => 'validate', 'data-display' => _e('Description'), 'rows' => 5, 'data-rules' => 'required')); ?></li>
          <li> <?php echo form_label('<dfn>' . _e('Type of Business') . '</dfn>', 'biz_type_id') ?> <?php echo form_dropdown('biz_type_id', $var['biz_types_dd'], $results["records"][0]->biz_type_id, 'id="biz_type_id" class="validate" data-display="' . _e('Type of Business') . '" data-rules="required"'); ?></li>
          <li> <?php echo form_label('<dfn>' . _e('Other Business type') . '</dfn>', 'other_biz_type_id') ?> <?php echo form_dropdown('other_biz_type_id', $var['biz_types_dd'], $results["records"][0]->other_biz_type_id, 'id="other_biz_type_id"'); ?></li>
          <li> <?php echo form_label('<dfn>' . _e('Country') . '</dfn>', 'country_id') ?> <?php echo form_dropdown('country_id', $var['countries_dd'], $results["records"][0]->country_id, 'id="country_id" onchange="getProvinceByCountry(this)" data-province-sel="#province_id" class="validate" data-display="' . _e('Country') . '" data-rules="required"'); ?></li>
          <li> <?php echo form_label('<dfn>' . _e('State/Province') . '</dfn>', 'province_id') ?> <?php echo form_dropdown('province_id', $var['provinces_dd'], $results["records"][0]->province_id, 'id="province_id" disabled="disabled" onchange="getCountyByProvince(this)" data-county-sel="#county_id" class="validate" data-display="' . _e('Province') . '" data-rules="required"'); ?></li>
          <li> <?php echo form_label('<dfn>' . _e('County') . '</dfn>', 'county_id') ?> <?php echo form_dropdown('county_id', $var['counties_dd'], $results["records"][0]->county_id, 'id="county_id" disabled="disabled" class="validate" data-display="' . _e('County') . '" data-rules="required"'); ?></li>
          <li>
          ...
          <li> <?php echo form_label('<dfn>' . _e('City') . '</dfn>', 'city') ?> <?php echo form_input(array('name' => 'city', 'size' => 30, 'value' => $results["records"][0]->city, 'id' => 'city', 'placeholder' => 'city')); ?></li>
          <li> <?php echo form_label('<dfn>' . _e('Asking Price') . '</dfn>', 'asking_price') ?> <?php echo form_input(array('name' => 'asking_price', 'size' => 30, 'value' => $results["records"][0]->asking_price, 'id' => 'asking_price', 'placeholder' => 'asking price')); ?></li>
          <li>
          ...
          <li> <?php echo form_label('<dfn>' . _e('Year Established') . '</dfn>', 'year_established') ?> <?php echo form_input(array('name' => 'year_established', 'id' => 'year_established', 'size' => 30, 'value' => $results["records"][0]->year_established, 'placeholder' => 'e.g. 1999')); ?></li>
          <li> <?php echo form_label('<dfn>' . _e('Employees') . '</dfn>', 'employees') ?> <?php echo form_input(array('name' => 'employees', 'id' => 'employees', 'size' => 30, 'value' => $results["records"][0]->employees, 'placeholder' => 'e.g. 8 FTE; 4 PTE')); ?></li>
          <li> <?php echo form_label('<dfn>' . _e('Business Website') . '</dfn>', 'biz_website') ?> <?php echo form_input(array('name' => 'biz_website', 'id' => 'biz_website', 'size' => 30, 'value' => $results["records"][0]->biz_website, 'placeholder' => 'add business website here')); ?></li>
          <li><?php echo form_label('<dfn>' . _e('Gross Revenue') . '</dfn>', 'gross_revenue') ?> <?php echo form_input(array('name' => 'gross_revenue', 'id' => 'gross_revenue', 'size' => 30, 'value' => $results["records"][0]->gross_revenue, 'placeholder' => 'add gross revenue here')); ?></li>
          <li> <?php echo form_label('<dfn>' . _e('Gross Revenue Comments') . '</dfn>', 'gross_revenue_comments') ?> <?php echo form_input(array('name' => 'gross_revenue_comments', 'id' => 'gross_revenue_comments', 'size' => 30, 'value' => $results["records"][0]->gross_revenue_comments, 'placeholder' => 'add gross revenue comments here')); ?></li>
          <li> <?php echo form_label('<dfn>' . _e('Cash Flow') . '</dfn>', 'cash_flow') ?> <?php echo form_input(array('name' => 'cash_flow', 'id' => 'cash_flow', 'size' => 30, 'value' => $results["records"][0]->cash_flow, 'placeholder' => 'add cash flow here')); ?></li>
          <li><?php echo form_label('<dfn>' . _e('Cash Flow Comments') . '</dfn>', 'cash_flow_comments') ?> <?php echo form_input(array('name' => 'cash_flow_comments', 'id' => 'cash_flow_comments', 'size' => 30, 'value' => $results["records"][0]->cash_flow_comments, 'placeholder' => 'add cash flow comments here')); ?></li>
          <li> <?php echo form_label('<dfn>' . _e('Value of Inventory') . '</dfn>', 'inv_value') ?> <?php echo form_input(array('name' => 'inv_value', 'id' => 'inv_value', 'size' => 30, 'value' => $results["records"][0]->inv_value, 'placeholder' => 'add value of inventory here')); ?></li>
          <li>
          ...
          <li> <?php echo form_label('<dfn>' . _e('Value of FF&E') . '</dfn>', 'ffe_value') ?> <?php echo form_input(array('name' => 'ffe_value', 'id' => 'ffe_value', 'size' => 30, 'value' => $results["records"][0]->ffe_value, 'placeholder' => 'add Furniture, Fixtures, and Equipment price here')); ?></li>
          <li>
          ...
          <li> <?php echo form_label('<dfn>' . _e('Value of Real Estate') . '</dfn>', 'rs_value') ?> <?php echo form_input(array('name' => 'rs_value', 'class' => 'rs_value margin-bottom10', 'id' => 'rs_value', 'size' => 30, 'value' => $results["records"][0]->rs_value, 'placeholder' => 'add real estate price here')); ?><br />
          ...
          <li> <?php echo form_label('<dfn>' . _e('Seller Financing Info.') . '</dfn>', 'seller_fincng_info') ?> <?php echo form_textarea(array('name' => 'seller_fincng_info', 'id' => 'seller_fincng_info', 'size' => 30, 'value' => $results["records"][0]->seller_fincng_info, 'placeholder' => 'add seller financing info here', 'rows' => 5)); ?></li>
          <li><?php echo form_label('<dfn>' . _e('Training & Support') . '</dfn>', 'training_support') ?> <?php echo form_textarea(array('name' => 'training_support', 'id' => 'training_support', 'value' => $results["records"][0]->training_support, 'placeholder' => 'add training support info here', 'rows' => 5)); ?></li>
          <li> <?php echo form_label('<dfn>' . _e('Reason for Selling') . '</dfn>', 'selling_reason') ?> <?php echo form_textarea(array('name' => 'selling_reason', 'id' => 'selling_reason', 'value' => $results["records"][0]->selling_reason, 'placeholder' => 'add reason for selling here', 'rows' => 5)); ?></li>
          <li> <?php echo form_label('<dfn>' . _e('Facilities') . '</dfn>', 'facilities') ?> <?php echo form_textarea(array('name' => 'facilities', 'id' => 'facilities', 'value' => $results["records"][0]->facilities, 'placeholder' => 'add facilities here', 'rows' => 5)); ?></li>
          <li> <?php echo form_label('<dfn>' . _e('Market Outlook/Competition') . '</dfn>', 'mkt_outlook_cmp') ?> <?php echo form_textarea(array('name' => 'mkt_outlook_cmp', 'id' => 'mkt_outlook_cmp', 'value' => $results["records"][0]->mkt_outlook_cmp, 'placeholder' => 'add about market outlook and competition info here', 'rows' => 5)); ?></li>
          <li> <?php echo form_label('<dfn>' . _e('Keywords') . '</dfn>', 'keywords') ?> <?php echo form_textarea(array('name' => 'keywords', 'id' => 'keywords', 'value' => $results["records"][0]->keywords, 'placeholder' => 'add about keywords here', 'rows' => 5)); ?></li>
          <li><?php echo form_label('<dfn>' . _e('Images') . '</dfn>', 'images') ?>          		
                <div id="imageUpload">
