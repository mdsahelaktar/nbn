        ...
        <div class="width725 float-left">
          ...
          <div class="width95 bg-grey padding-bottom10 padding-left20 padding-right20 padding-top10 float-left margin-top20">
            <p class="font14"><?php echo _e('Refine Your Search Here or go to') ?> <a href="#" target="_self" class="global"><?php echo _e('Advanced Search for More Options')?></a></p>
            	<div class="formwrap">
            <?php echo form_open( '', array( 'name' => 'inner_search_form', 'id' => 'srpform', 'class' => 'margin-top15', 'method' => 'post' ,'onsubmit' => 'return searchBizForm(this)') )?>	<ul>
            <li><div class="customeselect"> <?php echo form_label( '<dfn>'._e( 'Country' ).'</dfn>', 'country_id' )?>
         <?php echo form_dropdown('country_id', $var['country_dd'], $country_id, 'id="country_id" onchange="getProvinceByCountry(this)" data-province-sel="#province_id" data-display="'._e( 'Location' ).'" data-rules="required"'); ?>
            ...
            <li><div class="customeselect"> <?php echo form_label( '<dfn>'._e( 'Location' ).'</dfn>', 'province_id' )?> <?php echo form_dropdown('province_id', $var['provinces_dd'], $province_id, 'id="province_id"  onchange="getCountyByProvince(this)" data-county-sel="#county_id" data-display="'._e( 'Province' ).'" data-rules="required"');?> </div></li>
            ...
            <li><div class="customeselect"> <dfn>Segment:</dfn> <?php echo form_dropdown('biz_type_id', $var['biz_types_dd'], $biz_type_id, 'id="biz_type_id"  data-display="'._e( 'Type of Business' ).'"');?> </div></li>
                    ...
                    <li><input type="text" name="cfl" value="" id="cfl" placeholder="<?php echo _e('Cash Flow Low') ?>"></li>
                     ...
                     <li><label><input type="checkbox" name="is_fincng_avlble" id="is_fincng_avlble" value="1">Only show listings with Seller Financing</label></li></div>
                       ...
                       <a href="#" class="showhide"><?php echo _e('Advance Search') ?></a>
                    </div>
             </div>
            </div>
