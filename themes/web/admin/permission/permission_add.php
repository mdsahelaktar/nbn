...
<div class="clear"></div>
<?php echo form_submit( array( 'name' => 'permission_add', 'id' => 'permission_add', 'class' => 'margin-top10' ), _e( 'Add' ) );?> <?php echo form_close()?></div>
<?php
