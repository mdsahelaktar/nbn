...
<fieldset class="clonefieldset width25"><span class="otherbutton" ></span>
...
<?php echo form_label(_e( 'Languages' ))?> 
&nbsp;&nbsp;
<?php echo form_dropdown('language', $var['lang_dd'], '', 'id="language" onchange="showButton(this)" disabled="disabled" class="validate" data-display="'._e( 'Language' ).'" data-rules="required"');?>

<div class="clear">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
<div id="buttondiv" style="display:none">
<?php echo form_submit( array( 'name' => 'lang', 'id' => 'lang', 'class' => 'viewicon btn-type1 margin-right10 margin-top10 float-left' ), _e( 'View' ) );?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo anchor( 'javascript:void(0);', '<span class="ion-android-add"></span>'._e( 'Add' ), array( 'title' => _e( 'Add Language' ), 'class' => 'btn-type1 margin-right5 margin-top10 float-left', 'onclick'=>"return addLanguage();" ) )?>
</div>
