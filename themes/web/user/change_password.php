	...
	<div class="formwrap">
		<?php echo form_open('', array('name' => 'change_password_form', 'id' => 'change_password_form', 'class' => 'width100')) ?>
        	<ul> 
                ...
                <li><?php echo form_label('<dfn>' . _e('New Password') . '</dfn>', 'password') ?> <?php echo form_password(array('name' => 'password', 'id' => 'password', 'class' => 'validate', 'data-display' => _e('new_assword'), 'data-rules' => 'required|strict_password|matches[passconf]')); ?></li> 
