...
<div style="width:700px; margin:0px auto; background:#f8f8f8; ">
  ...
  <div style="width:100%; float:left; margin:10px 0 0 0; font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000000; text-align:left; text-decoration:none; line-height:18px; font-weight:bold; border-bottom:1px solid #49b8f0; padding:0 0 20px 0" > <br />
    <br />
