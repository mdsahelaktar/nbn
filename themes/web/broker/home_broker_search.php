...
<div class="float-left margin-right10">
    <?php echo form_input(array('name' => 'city', 'autocomplete' => 'off', 'data-as-province-sel' => '#home_broker_province_id', 'data-as-county-sel' => '#home_broker_county_id', 'style' => 'width: 130px; height: 28px;', 'class' => 'tpy', 'id' => 'city', 'placeholder' => 'Enter City', 'onkeypress' => 'autoSuggestCity(this)')); ?>
</div>
<p>
