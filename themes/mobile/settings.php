...
if( ! isAdminArea() )
{
	...
	$default_frontend_css = array("styles.css" , "ionic.css", "slimbox2.css","slicknav.css");
	
	$this->add_remove_frontend_js($default_frontend_js, "add");
	$this->add_remove_frontend_css($default_frontend_css, "add");
	
	## Fetch JS from admin ##
	$default_admin_js = array("jquery.slicknav.js","jquery.min.js", "custom.js", "cbpAnimatedHeader.js", "cbpAnimatedHeader.min.js", "jquery.tinycarousel.min.js", "jquery.idTabs.min.js","modernizr.custom.js", "classie.js", "slimbox2.js");
