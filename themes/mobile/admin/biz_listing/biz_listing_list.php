...
?>
<?php echo form_open( '', array( 'name' => 'biz_listing_edit_form', 'id' => 'biz_listing_edit_form', 'class' => 'width100 float-left margin-bottom30 margin-top10' ) );
echo form_hidden('row_id', $results["records"][0]->ai_biz_listing_id);
?> 
<?php echo form_label( '<p>'._e( 'Headline' ).'</p>', 'headline' )?> <?php echo form_input( array( 'name' => 'headline', 'id' => 'headline', 'size' => 30, 'value' => $results["records"][0]->headline, 'placeholder' => 'add headline here', 'autofocus' => 'autofocus', 'class' => 'validate', 'data-display' =>  _e( 'Headline' ), 'data-rules' => 'required') );?>
<div class="clear"></div>
<?php echo form_label( '<p>'._e( 'Tagline' ).'</p>', 'tagline' )?>
<?php echo form_input( array( 'name' => 'tagline', 'id' => 'tagline', 'size' => 30, 'value' => $results["records"][0]->tagline, 'placeholder' => 'add tagline here', 'class' => 'validate', 'data-display' =>  _e( 'Tagline' ), 'data-rules' => 'required') );?>
<div class="clear"></div>
...
<?php echo form_dropdown('biz_type_id', $var['biz_types_dd'], $results["records"][0]->biz_type_id, 'id="biz_type_id" class="validate" data-display="'._e( 'Type of Business' ).'" data-rules="required"');?>
<div class="clear"></div>
<?php echo form_label( '<p>'._e( 'Other Business type' ).'</p>', 'other_biz_type_id' )?>
<?php echo form_dropdown('other_biz_type_id', $var['biz_types_dd'], $results["records"][0]->other_biz_type_id, 'id="other_biz_type_id"');?>
<div class="clear"></div>
<?php echo form_label( '<p>'._e( 'Country' ).'</p>', 'country_id' )?>
<?php echo form_dropdown('country_id', $var['countries_dd'], $results["records"][0]->country_id, 'id="country_id" onchange="getProvinceByCountry(this)" data-province-sel="#province_id" class="validate" data-display="'._e( 'Country' ).'" data-rules="required"');?>
<div class="clear"></div>
<?php echo form_label( '<p>'._e( 'State/Province' ).'</p>', 'province_id' )?>
<?php echo form_dropdown('province_id', $var['provinces_dd'], $results["records"][0]->province_id, 'id="province_id" disabled="disabled" onchange="getCountyByProvince(this)" data-county-sel="#county_id" class="validate" data-display="'._e( 'Province' ).'" data-rules="required"');?>
<div class="clear"></div>
<?php echo form_label( '<p>'._e( 'County' ).'</p>', 'county_id' )?>
<?php echo form_dropdown('county_id', $var['counties_dd'], $results["records"][0]->county_id, 'id="county_id" disabled="disabled" class="validate" data-display="'._e( 'County' ).'" data-rules="required"');?>
<div class="clear"></div>
<?php echo form_checkbox('is_county_cnfdntl', 1, $results["records"][0]->is_county_cnfdntl, 'id="is_county_cnfdntl"');?>
...
<?php echo form_input( array( 'name' => 'city', 'size' => 30, 'value' => $results["records"][0]->city, 'id' => 'city', 'placeholder' => 'city' ) );?>
<div class="clear"></div>
<?php echo form_label( '<p>'._e( 'Asking Price' ).'</p>', 'asking_price' )?>
<?php echo form_input( array( 'name' => 'asking_price', 'size' => 30, 'value' => $results["records"][0]->asking_price, 'id' => 'asking_price', 'placeholder' => 'asking price' ) );?>
<div class="clear"></div>
<?php echo form_checkbox('is_fincng_avlble', 1, $results["records"][0]->is_fincng_avlble, 'id="is_fincng_avlble"');?>
...
<?php echo form_input( array( 'name' => 'year_established', 'id' => 'year_established', 'size' => 30, 'value' => $results["records"][0]->year_established, 'placeholder' => 'e.g. 1999' ) );?>
<div class="clear"></div>
<?php echo form_label( '<p>'._e( 'Employees' ).'</p>', 'employees' )?>
<?php echo form_input( array( 'name' => 'employees', 'id' => 'employees', 'size' => 30, 'value' => $results["records"][0]->employees, 'placeholder' => 'e.g. 8 FTE; 4 PTE' ) );?>
<div class="clear"></div>
<?php echo form_label( '<p>'._e( 'Business Website' ).'</p>', 'biz_website' )?>
<?php echo form_input( array( 'name' => 'biz_website', 'id' => 'biz_website', 'size' => 30, 'value' => $results["records"][0]->biz_website, 'placeholder' => 'add business website here' ) );?>
<div class="clear"></div>
<?php echo form_label( '<p>'._e( 'Gross Revenue' ).'</p>', 'gross_revenue' )?>
<?php echo form_input( array( 'name' => 'gross_revenue', 'id' => 'gross_revenue', 'size' => 30, 'value' => $results["records"][0]->gross_revenue, 'placeholder' => 'add gross revenue here' ) );?>
<div class="clear"></div>
<?php echo form_label( '<p>'._e( 'Gross Revenue Comments' ).'</p>', 'gross_revenue_comments' )?>
<?php echo form_input( array( 'name' => 'gross_revenue_comments', 'id' => 'gross_revenue_comments', 'size' => 30, 'value' => $results["records"][0]->gross_revenue_comments, 'placeholder' => 'add gross revenue comments here' ) );?>
<div class="clear"></div>
<?php echo form_label( '<p>'._e( 'Cash Flow' ).'</p>', 'cash_flow' )?>
<?php echo form_input( array( 'name' => 'cash_flow', 'id' => 'cash_flow', 'size' => 30, 'value' => $results["records"][0]->cash_flow, 'placeholder' => 'add cash flow here' ) );?>
<div class="clear"></div>
<?php echo form_label( '<p>'._e( 'Cash Flow Comments' ).'</p>', 'cash_flow_comments' )?>
<?php echo form_input( array( 'name' => 'cash_flow_comments', 'id' => 'cash_flow_comments', 'size' => 30, 'value' => $results["records"][0]->cash_flow_comments, 'placeholder' => 'add cash flow comments here' ) );?>
<div class="clear"></div>
<?php echo form_label( '<p>'._e( 'Value of Inventory' ).'</p>', 'inv_value' )?>
<?php echo form_input( array( 'name' => 'inv_value', 'id' => 'inv_value', 'size' => 30, 'value' => $results["records"][0]->inv_value, 'placeholder' => 'add value of inventory here' ) );?>
<div class="clear"></div>
<?php echo form_checkbox('is_inv_included', 1, $results["records"][0]->is_inv_included, 'id="is_inv_included"');?>
...
<?php echo form_input( array( 'name' => 'ffe_value', 'id' => 'ffe_value', 'size' => 30, 'value' => $results["records"][0]->ffe_value, 'placeholder' => 'add Furniture, Fixtures, and Equipment price here' ) );?>
<div class="clear"></div>
<?php echo form_checkbox('is_ffe_included', 1, $results["records"][0]->is_ffe_included, 'id="is_ffe_included"');?>
...
<?php echo form_input( array( 'name' => 'rs_value', 'id' => 'rs_value', 'size' => 30, 'value' => $results["records"][0]->rs_value, 'placeholder' => 'add real estate price here' ) );?>
<div class="clear"></div>
...
<?php echo form_textarea( array( 'name' => 'seller_fincng_info', 'id' => 'seller_fincng_info', 'size' => 30, 'value' => $results["records"][0]->seller_fincng_info, 'placeholder' => 'add seller financing info here', 'rows' => 5) );?>
<div class="clear"></div>
<?php echo form_label( '<p>'._e( 'Training & Support' ).'</p>', 'training_support' )?>
<?php echo form_textarea( array( 'name' => 'training_support', 'id' => 'training_support', 'value' => $results["records"][0]->training_support, 'placeholder' => 'add training support info here', 'rows' => 5) );?>
<div class="clear"></div>
<?php echo form_label( '<p>'._e( 'Reason for Selling' ).'</p>', 'selling_reason' )?>
<?php echo form_textarea( array( 'name' => 'selling_reason', 'id' => 'selling_reason', 'value' => $results["records"][0]->selling_reason, 'placeholder' => 'add reason for selling here', 'rows' => 5) );?>
<div class="clear"></div>
<?php echo form_label( '<p>'._e( 'Facilities' ).'</p>', 'facilities' )?>
<?php echo form_textarea( array( 'name' => 'facilities', 'id' => 'facilities', 'value' => $results["records"][0]->facilities, 'placeholder' => 'add facilities here', 'rows' => 5) );?>
<div class="clear"></div>
<?php echo form_label( '<p>'._e( 'Market Outlook/Competition' ).'</p>', 'mkt_outlook_cmp' )?>
<?php echo form_textarea( array( 'name' => 'mkt_outlook_cmp', 'id' => 'mkt_outlook_cmp', 'value' => $results["records"][0]->mkt_outlook_cmp, 'placeholder' => 'add about market outlook and competition info here', 'rows' => 5) );?>
<div class="clear"></div>
<?php echo form_label( '<p>'._e( 'Keywords' ).'</p>', 'keywords' )?>
<?php echo form_textarea( array( 'name' => 'keywords', 'id' => 'keywords', 'value' => $results["records"][0]->keywords, 'placeholder' => 'add about keywords here', 'rows' => 5) );?>
<div class="clear"></div>
<?php echo form_hidden('method', 'edit'); ?>
<?php echo form_submit( array( 'name' => 'biz_listing_update', 'id' => 'biz_listing_update', 'class' => 'margin-top10' ), _e( 'Update' ) );?> <?php echo form_close()?>
<?php
...
<table>
  <tr id="button_section">
    <td colspan="39"><?php echo anchor( 'admin/biz_listing/edit',_e( 'Reset' ), array( 'title' => _e( 'Reset' ), 'class' => 'btn-type1 margin-right10 margin-top10 float-left' ) )?> <?php echo form_button( array( 'name' => 'search', 'id' => 'search', 'class' => 'margin-top10', 'onclick' => 'return goFilter(this)' ), _e( 'Filter' ) );?></td>
  </tr>
...
?>
  ...
  <tr>
    <td><?php echo form_checkbox('row_id[]', $value->ai_biz_listing_id);?><?php echo $value->headline?></td>
    <td><?php echo $value->tagline?></td>
    <td><?php echo $value->description?></td>
    <td><?php echo $value->biz_type_id?></td>
    <td><?php echo $value->other_biz_type_id?></td>
    <td><?php echo $value->country_id?></td>
    <td><?php echo $value->province_id?></td>
    <td><?php echo $value->county_id?></td>
    <td><?php echo $value->is_county_cnfdntl?></td>
    <td><?php echo $value->city?></td>
    <td><?php echo $value->asking_price?></td>
    <td><?php echo $value->is_fincng_avlble?></td>
    <td><?php echo $value->year_established?></td>
    <td><?php echo $value->employees?></td>
    <td><?php echo $value->biz_website?></td>
    <td><?php echo $value->gross_revenue?></td>
    <td><?php echo $value->gross_revenue_comments?></td>
    <td><?php echo $value->cash_flow?></td>
    <td><?php echo $value->cash_flow_comments?></td>
    <td><?php echo $value->inv_value?></td>
    <td><?php echo $value->is_inv_included?></td>
    <td><?php echo $value->ffe_value?></td>
    <td><?php echo $value->is_ffe_included?></td>
    <td><?php echo $value->rs_value?></td>
    <td><?php echo $value->is_rs_included?></td>
    <td><?php echo $value->is_biz_relctble?></td>
    <td><?php echo $value->is_biz_franchis?></td>
    <td><?php echo $value->is_biz_hb?></td>
    <td><?php echo $value->seller_fincng_info?></td>
    <td><?php echo $value->training_support?></td>
    <td><?php echo $value->selling_reason?></td>
    <td><?php echo $value->facilities?></td>
    <td><?php echo $value->mkt_outlook_cmp?></td>
    ...
    <td><a href="<?php echo createEditUrl($value->ai_biz_listing_id)?>" class="ion-edit"></a>|<a href="<?php echo createRevertDeleteUrl($value->ai_biz_listing_id, $value->is_trashed)?>" class="editrevert<?php echo $value->is_trashed?>"></a></td>
  </tr>
  <?php endforeach;?>
  <tr>
