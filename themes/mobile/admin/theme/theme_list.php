...
?>
<?php echo form_open( '', array( 'name' => 'theme_edit_form', 'id' => 'theme_edit_form', 'class' => 'width100 float-left margin-bottom30 margin-top10' ) );
...
<div class="clear"></div>
<?php echo form_submit( array( 'name' => 'theme_update', 'id' => 'theme_update', 'class' => 'margin-top10' ), _e( 'Update' ) );?> <?php echo form_close()?>
<?php
...
<table>
  <tr id="button_section">
    <td colspan="6"><?php echo anchor( 'admin/theme/edit',_e( 'Reset' ), array( 'title' => _e( 'Reset' ), 'class' => 'btn-type1 margin-right10 margin-top10 float-left' ) )?> <?php echo form_button( array( 'name' => 'search', 'id' => 'search', 'class' => 'margin-top10', 'onclick' => 'return goFilter(this)' ), _e( 'Filter' ) );?></td>
  </tr>
...
?>
  ...
  <tr>
    <td><?php echo form_checkbox('row_id[]', $value->ai_theme_id);?><?php echo $value->theme?></td>
    <td><?php echo $value->is_current ? _e('Current') : ''?></td>
    <td><?php echo $value->creation_time?></td>
    <td><?php echo $value->update_time?></td>
    <td><?php echo $value->is_trashed ? _e("Inactive") : _e("Active")?></td>
    <td><a href="<?php echo createEditUrl($value->ai_theme_id)?>" class="ion-edit"></a>|<a href="<?php echo createRevertDeleteUrl($value->ai_theme_id, $value->is_trashed)?>" class="editrevert<?php echo $value->is_trashed?>"></a></td>
  </tr>
  <?php endforeach;?>
  <tr>
