...
<div class="formcont-small"><?php echo form_open( '', array( 'name' => 'context_add_form', 'id' => 'context_add_form', 'class' => 'width100 float-left margin-bottom30 margin-top10' ) )?>
...
<div class="clear"></div>
<?php echo form_submit( array( 'name' => 'context_add', 'id' => 'context_add', 'class' => 'margin-top10' ), _e( 'Add' ) );?> <?php echo form_close()?></div>
<?php
