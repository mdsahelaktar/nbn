...
?>
<?php echo form_open( '', array( 'name' => 'permission_group_edit_form', 'id' => 'permission_group_edit_form', 'class' => 'width100 float-left margin-bottom30 margin-top10' ) );
...
<table>
  <tr id="button_section">
    <td colspan="5"><?php echo anchor( 'admin/permission_group/edit',_e( 'Reset' ), array( 'title' => _e( 'Reset' ), 'class' => 'btn-type1 margin-right10 margin-top10 float-left' ) )?> <?php echo form_button( array( 'name' => 'search', 'id' => 'search', 'class' => 'margin-top10', 'onclick' => 'return goFilter(this)' ), _e( 'Filter' ) );?></td>
  </tr>
...
?>
  ...
  <tr>
    ...
    <td><a href="<?php echo createEditUrl($value->ai_permission_group_id)?>" class="ion-edit"></a>|<a href="<?php echo createRevertDeleteUrl($value->ai_permission_group_id, $value->is_trashed)?>" class="editrevert<?php echo $value->is_trashed?>"></a></td>
  </tr>
  <?php endforeach;?>
  <tr>
