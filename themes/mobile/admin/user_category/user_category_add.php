...
<?php 
### If No Error Begin ###
if(!$response["event"]["error"]):?>admin 
<?php echo form_open( '', array( 'name' => 'user_category_add_form', 'id' => 'user_category_add_form', 'class' => 'width100 float-left margin-bottom30 margin-top10' ) )?>
...
<div class="clear"></div>
<?php echo form_submit( array( 'name' => 'user_category_add', 'id' => 'user_category_add', 'class' => 'margin-top10' ), _e( 'Add' ) );?> <?php echo form_close()?>
<?php
