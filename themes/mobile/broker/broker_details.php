<!--body start-->
  <div id="body">
    ...
    <?php echo $details_slider ?>
    		<p>The information on this listing has been provided by either the seller or a business broker representing the seller. <?php echo _e('site_title')?> has no interest or stake in the sale of this business and has not verified any of the information and assumes no responsibility for its accuracy, veracity, or completeness.Please review our full Terms & Conditions here.</p>
            </div>
            </div>
