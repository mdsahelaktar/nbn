	 ...
	 ?>
      <div class="business">
            <img src="<?php echo $this->template->get_frontend_image(isset($biz->image_information)? showImage($biz->image_information, '1', '1','bizlisting/business4sale.png') : 'bizlisting/business4sale.png') ?>" >
			 ...
			 <ul>
				<li> <a href="#" class="global" target="_self"><?php echo isset($biz->province)?$pro : 'NA'; ?></a></li>
				<li> |</li>
...
?>
 <ul>
      ...
      <?php
        ...
        foreach($item as $biz):  
		?>
              <li> <a href="biz_listing/search?province_id=<?php echo $biz->ai_province_id;?>"><?php echo $biz->province.' '.'Businesses for Sale' ?></a></li>
