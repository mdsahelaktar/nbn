...
class Broker_model extends MY_Model {
	...
	function initialize()
	{
		$this->_configure 	= $this->config->item('broker_configure');
		$this->_validation = $this->config->item('broker_validation');
	}	
...
// END Broker Model Class

/* End of file user_category_model.php */
/* Broker: ./application/modules/user_category/models/user_category_model.php */